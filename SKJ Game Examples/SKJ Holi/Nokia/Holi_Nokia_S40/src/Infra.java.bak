...
public class Infra extends Canvas implements CommandListener
{
	...
	protected void menuFullCanvas()
	{
		this.menu1 = new List("SKJ Holi",List.IMPLICIT) ;
        this.menu1.append("Menu",null) ;
        this.menu1.append("Back",null) ;

        this.menu1.setCommandListener(this) ;
		this.parent.setDisplayable(this.menu1) ;
	    repaint();
	}
    /***************************************************/
